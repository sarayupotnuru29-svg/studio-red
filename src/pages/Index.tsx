...
const services = [
  { 
    ...
    desc: "We transform houses into elegant, personalized sanctuaries through thoughtful design and premium materials." 
  },
  { 
    image: serviceCommercial, 
    title: "Commercial Interiors", 
    desc: "Premium workspaces designed to inspire productivity and reflect your brand's unique identity." 
  },
  { 
    image: serviceTheater, 
    title: "Home Theatres", 
    desc: "Immersive cinema experiences with acoustically optimized designs tailored to your entertainment needs." 
  },
  { 
    image: serviceTurnkey, 
    title: "Turnkey Projects", 
    desc: "Complete end-to-end solutions from conceptualization to final handover—move in without lifting a finger." 
  },
  { 
    image: serviceProjectMgmt, 
    title: "Project Management", 
    desc: "Expert coordination of timelines and budgets to ensure your project is delivered with zero compromises." 
  },
  { 
    image: serviceExecution, 
    title: "Design & Execution", 
    desc: "Complete interior solutions from initial concept through final installation, managing every fine detail." 
  },
  { 
    image: serviceFalseCeiling, 
    title: "False Ceilings", 
    desc: "Stunning designs from minimalist modern profiles to elaborate coffered designs with integrated lighting." 
  },
  { 
    image: serviceModular, 
    title: "Modular Wardrobes & Kitchens", 
    desc: "Sleek, functional modular solutions with premium finishes and smart storage for everyday practicality." 
  },
  { 
    image: servicePainting, 
    title: "Painting & Customisation", 
    desc: "Bespoke wall treatments, custom murals, and artistic solutions that add personality to every room." 
  },
  { 
    image: serviceStone, 
    title: "Stone & Tile Solutions", 
    desc: "Premium Granite, Quartz, and Marble sourcing and installation for countertops and luxury flooring." 
  },
];
